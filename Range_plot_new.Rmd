...
pa3 = pa2 + scale_x_continuous(name = "MIC (mg/L)",limits = c(-5.5, 8.5), breaks = seq(-5, 8), labels = xlab)

pa3 = pa3 + geom_vline(xintercept= (log2(1)), colour = "red", linetype = "dashed")
pa3 = pa3 + coord_fixed(0.7)
subt = expression(paste("with breakpoint for ", italic("C.glabrata")))
pa3 = pa3 + labs(title = "Amphotericin B", subtitle = subt)
pa3 = pa3 + theme(plot.margin = unit(c(1,0.25,0.5,0.5), "cm"),
                  plot.title = element_text(hjust = 0, size = 30),
                  plot.subtitle=element_text(size=20, hjust=0,
                                             color = "red"), 
                  axis.title.x = element_text(size = 20),
...
s4 = s4 + theme(plot.margin = unit(c(1,0.25,0.5,0.5), "cm"),
                  plot.title = element_text(hjust = 0, size = 30), 
                  axis.title.x = element_text(size = 20),
                  axis.text.x = element_text(size = 12))
...
p2a3 = p2a2 + scale_x_continuous(name = "MIC (mg/L)",limits = c(-5.5, 8.5), breaks = seq(-5, 8), labels = xlab)

p2a3 = p2a3 + geom_vline(xintercept= (log2(1)), colour = "red", linetype = "dashed")
p2a3 = p2a3 + coord_fixed(0.7)
subt = expression(paste("with breakpoint for ", italic("C.glabrata")))
p2a3 = p2a3 + labs(title = "Amphotericin B", subtitle = subt)
p2a3 = p2a3 + theme(plot.margin = unit(c(1,0.25,0.5,0.5), "cm"),
                  plot.title = element_text(hjust = 0, size = 30),
                  plot.subtitle=element_text(size=20, hjust=0,
                                             color = "red"), 
                  axis.title.x = element_text(size = 20),
